...
class Producto extends Model
{
     ...
     * @var array
     */
    protected $fillable = ['nombre', 'ingles', 'precio', 'tiempo_costo','descripcion', 'estado', 'domicilio', 'midomicilio', 'sucursal', 'codigo', 'subcategoria_id', 'establecimiento_id','imagen','idoneidad', 'anos_experiencia','habilitado','fotos','acreditaciones'];
